...
Using the two figures here above (genereated using the functions \verb|vis_miss| and \verb|gg_miss_upset|) we can see that the missing values are not randomly distributed.
